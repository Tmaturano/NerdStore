...
/// <summary>
/// Abstraction of EasyNetQ so the API's will not depend of that package
/// If in the future it is decided to change from EasyNetQ to Azure for example (ServiceBus), or Kafka,
/// only this MessageBus will need the changes, the projects will remain the same
/// </summary>
